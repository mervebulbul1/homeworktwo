---
title: "Ödev 2"
author: "mervenur bülbül 19080207"
output: pdf_document
---
...
```{r}
wizards<-c('Harry',' Ron', 'Fred',' George ','Sirius')
wizards['Fred'] <- 'Hermione'
wizards['George'] <- 'GinnY'
wizards['Sirius'] <- 'Malfoy'
```
...
```{r}
wizards<-c('Harry',' Ron', 'Fred',' George ','Sirius')
wizards<-c('Harry'='Lead',' Ron'= 'Friend', 'Fred'= 'Friend',' George '= 'Wife' ,'Sirius'='Rival')
...
incomes<-c(22000,67000,70000)
expenses<-c(3000,23000,32000)
